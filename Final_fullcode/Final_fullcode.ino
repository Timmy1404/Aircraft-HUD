...
void setup(void) {
  ...
  Wire.write(0x6B); 
  Wire.write(0);
  Wire.endTransmission(false);  Serial.begin(9600);
...
int DrawElements(Adafruit_ST7789 tft, int Coordinates[][4], int ROWS) {
  ...
  tft.fillRect(0, 0, 240, 60, ST77XX_BLUE);
  tft.fillRect(0, 60, 45, 180, ST77XX_BLUE);
  tft.fillRect(195, 60, 45, 180, ST77XX_BLUE);
  tft.fillRect(0, 180, 240, 60, ST77XX_BLUE);
