...
void loop() {  
  ...
  AngleOfAttack1(x1O, y1O, x1F, y1F, ax);  
  AngleOfAttack1(x2O, y2O, x2F, y2F, ax); 
...
double AngleOfAttack1(double x1O, double y1O, double &x1F, double &y1F, double ax) {  //& = refrences value  
x1F = 120-(sqrt((x1O*x1O) + (y1O*y1O)) * sin(((ax + ((atan((x1O) / (y1O)))/M_PI)*180)/180)*M_PI));  
y1F = 120-(sqrt((x1O*x1O) + (y1O*y1O)) * cos(((ax + ((atan((x1O) / (y1O)))/M_PI)*180)/180)*M_PI));   
}  
